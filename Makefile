...
.PHONY: help check check-prereqs install init build start start-backend start-frontend test clean status update eject-frontend

# Default target: show help
help:
	@echo "Deno Transcription - Available Commands"
	@echo "========================================"
	@echo ""
	@echo "Setup:"
